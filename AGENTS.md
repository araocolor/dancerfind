...
## External User Rule Reference

Always read and follow `/Users/chalres/Projects/LOCO/user_rule.md` for user-specific instruction mapping before responding.
Always read and follow `/Users/chalres/Projects/LOCO/promise_100%_role.md` as a top-priority rule reference before responding.
If a response ends with `답변하겠습니다.` , `답하겠습니다.` , `실수입니다.`in the context of admitting a mistake, immediately append that promise sentence as a new line to `/Users/chalres/Projects/LOCO/promise_100%_role.md` in the same turn.
